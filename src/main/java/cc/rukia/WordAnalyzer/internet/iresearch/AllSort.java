...
public class AllSort implements HtmlBean {
    ...
    // 移动互联网
    @HtmlField(cssPath="body > div.g-web > div.g-bd.f-mt-auto > div > div.g-mn > div > div > div > div.m-hd.m-hd-bg.ire-hidden > ul > li.z-crt > a")
    private List<Category> mobileInternet;

    // 电子商务
    @HtmlField(cssPath="body > div.g-web > div.g-bd.f-mt-auto > div > div.g-mn > div > div > div > div.m-hd.m-hd-bg.ire-hidden > ul > li:nth-child(2) > a")
